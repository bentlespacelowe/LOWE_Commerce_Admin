                ...
                <Slider {...settings}>
                    {
                        ...
                        this.state.data.map((e)=>{
                            count = count + 1;
                        return (<div key={e} className="Board_first_img" onChange={this.onChangeNumber(count)}>
                                <img src={e} alt="로위 배너" />
                            </div>)
                         }) :
                        <></>
                        ...
                        <div className="Board_first_number">{this.state.activeSlide+1}<span> / {this.state.data.length}</span></div>
            </section>
        )
    }
}
