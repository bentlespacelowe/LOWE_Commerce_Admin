...
class couponcreate extends Component {
    ...
    handleImgValue = async () => {
        ...
        await axios.post("http://3.36.218.192:5000/createCoupon", {
            UserId: id,
        ...
        return (
            <section className="designer">
                ...
                <div>
                    <input
                        type="text"
                        onChange={this.handleInputValue("expired")}
                        placeholder="만료날짜(ex. 1999-01-01)"
                        id="cexpired"
                    />
                </div>
                <div>최저금액</div>
                <div>
                    <input
                        type="text"
                        onChange={this.handleInputValue("minimum")}
                        placeholder="최저금액"
                        id="cminimum"
                    />
                </div>
