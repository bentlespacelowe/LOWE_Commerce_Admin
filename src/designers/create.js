...
class create extends Component {
    ...
    handleEditDesigner = async () => {
        ...
        await axios
            .patch("http://3.36.218.192:5000/manager", {
        ...
        return (
            <section className="goods">
                ...
                <div>
                    ...
                    <select name="user_state" id="duser_state" onChange={this.handleInputValue("user_state")}>
                        <option value={this.state.user_state ? this.state.user_state : ''}>
                            {
                                this.state.user_state === "0" ? "비공개" :
                                this.state.user_state === "1" ? "공개" : ""
                            }
                        </option>
                ...
                <span>직급</span>
                    <input
                        type="text"
                        onChange={this.handleInputValue("rank")}
                        placeholder="ex) 원장 / 디자이너"
                        id="drank"
                    />
                </div>
                <div>
                ...
                <span>시간</span>
                    <input
                        type="text"
                        onChange={this.handleInputValue("operating_time")}
                        placeholder="영업 시간"
                        id="dtime"
                    />
                </div>
                ...
                <span>휴무일</span>
                    <input
                        ...
                        placeholder="ex) 명절 당일 휴무 / 일요일 휴무"
                        id="dhome"
                    />
                </div>
                <div>
                <span>인스타그램</span>
                    <input
                        type="text"
                        onChange={this.handleInputValue("sns")}
                        placeholder="영업 시간"
                        id="dsns"
                    />
                </div>
                ...
                <div  style={{display: "inline-block"}}>
                    {
                        this.state.hashtags ?
                            this.state.hashtags.map((e, i) => (
                                    <div style={{backgroundColor: "#ffffff", float:"left", border: "1px solid #F5F5F5", cursor: "pointer", padding: "5px",height: "20px", marginRight: "10px", marginBottom: "10px"}} >
                                       <span onClick={this.onClickhashup(i)} style={{margin: "0", padding:"0 5px",height:"20px",lineHeight: "20px",textAlign: "center"}}>{"<"}</span> <span onClick={this.onClickDelhash(i)} style={{margin: "0", height:"20px",lineHeight: "20px",textAlign: "center"}}>{e.content}</span><span onClick={this.onClickhashdown(i)} style={{margin: "0", height:"20px",padding:"0 5px",lineHeight: "20px",textAlign: "center"}}>{">"}</span>
                                     </div>
                            ))
                            : null
                    }
                ...
                <div>
                    <div>
                        <input
                            type="text"
                            onChange={this.handleInputValue("hash")}
                            placeholder="ex) 컷트"
                            id="hash"
                        />
                    </div>
                ...
                <div>
                    <div style={{ marginBottom: "20px" }}>
                        <input
                            type="text"
                            onChange={this.handleInputValue("mainimglink")}
                            placeholder="링크"
                            id="mainimglink"
                        />
                    </div>
                ...
                <div>
                    ...
                    <div>
                        <input
                            type="text"
                            onChange={this.handleInputValue("surcontent")}
                            placeholder="이름"
                            id="surcontent"
                        />
                    </div>
                    <div>
                        <input
                            type="number"
                            onChange={this.handleInputValue("surprice")}
                            placeholder="가격"
                            id="surprice"
                        />
                    </div>
                    <div style={{ marginBottom: "20px" }}>
                        <input
                            type="text"
                            onChange={this.handleInputValue("sururl")}
                            placeholder="링크"
                            id="sururl"
                        />
                    </div>
                ...
                {this.state.coupon === "1" ?
                    <div style={{ marginBottom: "40px" }}>
                        ...
                        <input
                            type="text"
                            onChange={this.handleInputValue("coupontext")}
                            placeholder="쿠폰 목적"
                            id="coupontext"
                        />
                        </div>
                        ...
                        <input
                            type="number"
                            onChange={this.handleInputValue("couponprice")}
                            placeholder="쿠폰 가격"
                            id="couponprice"
                        />
                        </div>
                        ...
                        <input
                            type="text"
                            onChange={this.handleInputValue("couponexpired")}
                            placeholder="만료날짜(2022-11-11)"
                            id="couponexpired"
                        />
                        </div>
                        <div>
                        <input
                            type="text"
                            onChange={this.handleInputValue("couponlimit")}
                            placeholder="쿠폰 제한"
                            id="couponlimit"
                        />
                        </div>
